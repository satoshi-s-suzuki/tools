            ...
            function (module, exports, __webpack_require__) {
                ...
                exports.$eval = function (text) {
                    ...
                    if (filterRE.test(text)) {
                        ...
                        return dir.filters ? _.applyFilters(
...
/***/
            function (module, exports, __webpack_require__) {
                ...
                function insert(vm, target, cb, withTransition, op1, op2) {
                    ...
                    var shouldCallHook = !targetIsDetached &&
                        !vm._isAttached &&
                        !_.inDoc(vm.$el)
                    if (vm._isBlock) {
                ...
                strats.directives =
                    ...
                    strats.components = function (parentVal, childVal, vm, key) {
                        var ret = Object.create(
                            vm && vm.$parent ? vm.$parent.$options[key] : _.Vue.options[key]
                        )
                        if (parentVal) {
            ...
            function (module, exports, __webpack_require__) {
                ...
                module.exports = {
                    ...
                    checkRef: function () {
                        ...
                        this.childId = childId ? this.vm.$interpolate(childId) : null
            ...
            function (module, exports, __webpack_require__) {
                ...
                module.exports = {
                    ...
                    compile: function (template) {
                        ...
                        var originalChildLength = vm._children ? vm._children.length : 0
                        this.unlink = this.linker ? this.linker(vm, frag) : vm.$compile(frag)
                        transition.blockAppend(frag, this.end, vm)
                        this.children = vm._children ? vm._children.slice(originalChildLength) : null
                        ...
                        if (raw) {
                            ...
                            if (select) { // select content
                                ...
                                outlet.content = _.toArray(
                                    selected.length ? selected : outlet.childNodes
                                )
